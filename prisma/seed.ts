...
async function main() {
  ...
  const agentSeeds = [
    ...
    },
    {
      ...
      email: "m.alkaya@wohnwert-immobilien.example",
      phone: "+49 221 23125 103",
      imageUrl: img("1580489944761-15a19d654956", 800),
      bio: "Miriam Alkaya verantwortet den Bereich Gewerbe- und Investmentimmobilien. Sie kommt aus der Bankenanalyse und rechnet jedes Objekt durch, bevor sie es empfiehlt – auch dann, wenn das Ergebnis gegen einen Abschluss spricht.",
    ...
    },
    {
      ...
      email: "t.remmel@wohnwert-immobilien.example",
      phone: "+49 221 23125 104",
      imageUrl: img("1507003211169-0a1dd7228f2d", 800),
      bio: "Tobias Remmel betreut das Umland: Bergisches Land, Rhein-Sieg-Kreis und die Eifel. Er ist dort aufgewachsen und weiß, welche Straße nachmittags Sonne hat und wo der Schulbus tatsächlich hält.",
  ...
  const reviews = [
    {
      ...
      body: "Wir haben das Haus unserer Eltern zu dritt geerbt und hatten unterschiedliche Vorstellungen. Frau Voßwinkel hat sich Zeit genommen, mit jedem einzeln zu sprechen, bevor sie einen Vorschlag gemacht hat. Am Ende waren wir uns einig – und der erzielte Preis lag über dem, womit wir gerechnet hatten.",
      city: "Köln",
    ...
    },
    {
      ...
      body: "Zwei andere Makler hatten mir vorher deutlich höhere Preise genannt. Herr Hartmann hat mir erklärt, warum diese Zahlen unrealistisch sind, und was das für die Vermarktungsdauer bedeutet hätte. Die Wohnung war nach fünf Wochen verkauft – zum genannten Preis.",
      city: "Bonn",
    ...
    },
    {
      ...
      body: "Frau Alkaya hat mir bei einem Objekt abgeraten, das ich unbedingt kaufen wollte – mit einer Rechnung, der ich nicht widersprechen konnte. Beim zweiten Objekt hat sie zugeraten. Das war die richtige Entscheidung.",
      city: "Köln",
    ...
    },
    {
      ...
      body: "Wir hatten überhaupt keine Erfahrung und entsprechend viele Fragen – auch solche, die man sich fast nicht traut zu stellen. Herr Remmel hat jede davon beantwortet, ohne dass wir uns dumm vorkamen.",
      city: "Hennef",
      propertyType: "HAUS" as const,
      serviceType: "Kauf",
      daysAgo: 58,
  ...
  const categories = await Promise.all(
    [
      { slug: "verkaufen", name: "Verkaufen", description: "Ablauf, Vorbereitung und Preisfindung beim Immobilienverkauf." },
      { slug: "bewerten", name: "Bewerten", description: "Wie Immobilienwerte entstehen und was sie beeinflusst." },
      { slug: "recht-und-kosten", name: "Recht & Kosten", description: "Provision, Steuern, Unterlagen und rechtliche Fragen." },
      { slug: "energie", name: "Energie & Sanierung", description: "Energieausweis, Sanierungspflichten und Förderungen." },
  ...
  const posts = [
    {
      slug: "immobilie-verkaufen-ablauf",
      title: "Immobilie verkaufen: der Ablauf in neun Schritten",
      excerpt:
      ...
      categoryId: cat["verkaufen"],
      readingMinutes: 9,
      coverImage: img("1560518883-ce09059eeffa", 1400),
      author: 0,
      daysAgo: 6,
      seoTitle: "Immobilie verkaufen: Ablauf in 9 Schritten | Ratgeber",
      seoDescription:
      ...
      content: `Die meisten Eigentümer unterschätzen nicht den Aufwand des Verkaufs, sondern die Zeit, die zwischen den einzelnen Schritten vergeht. Wer den Ablauf kennt, plant realistischer – und trifft bessere Entscheidungen.

## 1. Klarheit über das eigene Ziel

Bevor über Preise gesprochen wird, sollte eine andere Frage beantwortet sein: Was ist wichtiger – der höchstmögliche Preis oder ein sicherer Termin? Beides gleichzeitig gibt es selten. Wer bis zum Sommer verkauft haben muss, weil ein Umzug ansteht, verhandelt anders als jemand, der zwei Jahre Zeit hat.

## 2. Unterlagen zusammentragen

Dieser Schritt dauert fast immer länger als gedacht. Benötigt werden unter anderem Grundbuchauszug, Flurkarte, Baupläne, Wohnflächenberechnung, Energieausweis und – bei Eigentumswohnungen – Teilungserklärung sowie die Protokolle der letzten drei Eigentümerversammlungen.

Rechnen Sie mit zwei bis vier Wochen, wenn Unterlagen bei Ämtern angefordert werden müssen.

## 3. Wert ermitteln

Der Marktwert ergibt sich aus drei Verfahren: Vergleichswert, Ertragswert und Sachwert. Für selbstgenutzte Wohnimmobilien ist das Vergleichswertverfahren maßgeblich – entscheidend sind also tatsächlich erzielte Preise vergleichbarer Objekte, nicht Angebotspreise aus Portalen.

> Angebotspreise sagen aus, was Verkäufer sich wünschen. Kaufpreissammlungen sagen aus, was Käufer tatsächlich bezahlt haben. Der Unterschied beträgt im Rheinland derzeit fünf bis zwölf Prozent.

## 4. Über die Vermarktungsstrategie entscheiden

Öffentlich oder diskret? Portale oder gezielte Ansprache vorgemerkter Interessenten? Für ungewöhnliche Objekte oder Verkäufe in sensiblen Situationen ist die diskrete Variante oft die bessere.

## 5. Objekt vorbereiten

Kleine Maßnahmen mit großer Wirkung: aufräumen, entrümpeln, defekte Leuchtmittel tauschen, Fenster putzen. Größere Renovierungen rechnen sich vor dem Verkauf dagegen selten – Käufer honorieren fremde Geschmacksentscheidungen kaum.

## 6. Professionelle Aufbereitung

Fotos, Grundrisse, Exposé. Der erste Eindruck entsteht heute auf einem Bildschirm. Objekte mit schlechten Fotos erhalten messbar weniger Anfragen – und erzielen im Schnitt niedrigere Preise.

## 7. Besichtigungen

Qualifizierte Interessenten statt Laufkundschaft. Vor dem Termin sollte geklärt sein, ob die Finanzierung grundsätzlich steht. Das erspart beiden Seiten Zeit.

## 8. Verhandlung und Notartermin

Nach der Einigung wird der Kaufvertragsentwurf erstellt. Zwischen Entwurf und Beurkundung müssen bei Verbrauchern zwei Wochen liegen. Der Notartermin selbst dauert etwa eine Stunde.

## 9. Kaufpreiszahlung und Übergabe

Die Zahlung erfolgt erst, wenn alle Voraussetzungen erfüllt sind – üblicherweise vier bis acht Wochen nach der Beurkundung. Bei der Übergabe werden Zählerstände protokolliert und Schlüssel übergeben.
...
Von der Entscheidung bis zur Übergabe vergehen realistisch vier bis sechs Monate. Die Vermarktung selbst nimmt davon oft nur sechs bis zehn Wochen ein – der Rest entfällt auf Vorbereitung und die Abwicklung nach der Einigung.`,
    ...
    {
      slug: "was-ist-meine-immobilie-wert",
      title: "Was ist meine Immobilie wert? Die drei Verfahren erklärt",
      excerpt:
        "Vergleichswert, Ertragswert, Sachwert: Welches Verfahren wann greift – und warum Online-Rechner systematisch danebenliegen.",
      categoryId: cat["bewerten"],
      readingMinutes: 7,
      coverImage: img("1554224155-6726b3ff858f", 1400),
      author: 0,
      daysAgo: 19,
      seoTitle: "Immobilienwert ermitteln: Vergleichs-, Ertrags- und Sachwert",
      seoDescription:
      ...
      content: `Der Satz „Meine Nachbarn haben für ihr Haus 780.000 Euro bekommen" ist der häufigste Einstieg in ein Bewertungsgespräch. Er ist auch der häufigste Irrtum – denn zwei Häuser in derselben Straße können sich im Wert um 30 Prozent unterscheiden.

## Die drei anerkannten Verfahren

### Vergleichswertverfahren

Herangezogen werden tatsächlich erzielte Kaufpreise vergleichbarer Objekte aus der Kaufpreissammlung des Gutachterausschusses. Dieses Verfahren ist bei selbstgenutzten Wohnimmobilien und Eigentumswohnungen maßgeblich.

Entscheidend ist die Qualität der Vergleichsobjekte: gleiche Lage, ähnliche Größe, vergleichbares Baujahr und Ausstattungsniveau. Je weniger vergleichbare Verkäufe es gibt, desto unsicherer wird das Ergebnis.

### Ertragswertverfahren

Bei vermieteten Objekten steht nicht der Gebrauchswert im Vordergrund, sondern der Ertrag. Ausgangspunkt ist die nachhaltig erzielbare Jahresnettokaltmiete, von der Bewirtschaftungskosten abgezogen werden. Das Ergebnis wird über einen Liegenschaftszinssatz kapitalisiert.

### Sachwertverfahren

Hier wird gerechnet, was es kosten würde, das Gebäude neu zu errichten – abzüglich Alterswertminderung, zuzüglich Bodenwert. Angewendet wird es vor allem bei Objekten ohne echten Vergleichsmarkt.

## Was den Wert tatsächlich bewegt

Die Lage bestimmt bei Wohnimmobilien 40 bis 60 Prozent des Wertes. Danach folgen in dieser Reihenfolge:
...
Ein Algorithmus, der PLZ, Fläche und Baujahr verarbeitet, kann kein Objekt sehen. Er weiß nicht, dass die Fenster nach Norden zeigen, dass die Straße nachts laut ist oder dass das Bad 1978 zuletzt erneuert wurde.

Solche Rechner liefern eine Größenordnung, keine Bewertung. Für eine Verkaufsentscheidung reicht das nicht – für einen ersten Eindruck kann es genügen.

## Was eine seriöse Bewertung ausmacht

Sie beruht auf einer Besichtigung, nennt Vergleichsobjekte, erklärt Zu- und Abschläge nachvollziehbar und gibt eine Spanne statt einer Punktzahl an. Und sie ist unabhängig davon, ob daraus ein Auftrag entsteht.`,
    },
    {
      slug: "maklerprovision-erklaert",
      title: "Maklerprovision: Wer zahlt was – und wofür eigentlich?",
      excerpt:
      ...
      categoryId: cat["recht-und-kosten"],
      readingMinutes: 6,
      coverImage: img("1450101499163-c8848c66ca85", 1400),
      author: 1,
      daysAgo: 31,
      seoTitle: "Maklerprovision beim Immobilienverkauf: Höhe, Teilung, Fälligkeit",
      seoDescription:
      ...
      content: `Seit dem 23. Dezember 2020 gilt bei der Vermittlung von Einfamilienhäusern und Eigentumswohnungen an Verbraucher: Beauftragt der Verkäufer einen Makler, muss dieser mindestens die Hälfte der Provision selbst tragen.

## Die Regelung im Detail

Das Gesetz kennt zwei zulässige Modelle:

1. **Doppeltätigkeit mit Teilung**: Der Makler wird für beide Seiten tätig und erhält von beiden denselben Betrag.
2. **Abwälzungsverbot**: Beauftragt nur eine Partei, darf sie höchstens die Hälfte ihrer Provision auf die andere übertragen – und die Zahlung der anderen Seite ist erst fällig, wenn die beauftragende Partei nachweislich gezahlt hat.

Was nicht mehr geht: Der Verkäufer beauftragt, der Käufer zahlt alles.

## Übliche Höhe im Rheinland

Im Raum Köln/Bonn liegt die Gesamtprovision aktuell bei 5,95 Prozent inklusive Mehrwertsteuer, geteilt also 2,975 Prozent je Seite. Bei höherpreisigen Objekten wird häufig eine niedrigere Rate vereinbart.
...
Scheitert der Verkauf, entsteht kein Anspruch. Das ist der wesentliche Punkt: Die Vergütung ist vollständig erfolgsabhängig.

## Was zur Leistung gehört

Ein seriöser Maklervertrag beschreibt die Leistung konkret. Dazu sollten mindestens gehören:
...
## Für Ausnahmen gilt anderes

Bei Mehrfamilienhäusern, Grundstücken und Gewerbeobjekten sowie bei Verkäufen zwischen Unternehmern greift die gesetzliche Teilung nicht. Hier ist die Provisionsverteilung frei verhandelbar.`,
    },
    {
      slug: "unterlagen-immobilienverkauf",
      title: "Unterlagen beim Immobilienverkauf: die vollständige Checkliste",
      excerpt:
        "Welche Dokumente Sie brauchen, wo Sie sie bekommen, was sie kosten und wie lange die Beschaffung dauert.",
      categoryId: cat["verkaufen"],
      readingMinutes: 8,
      coverImage: img("1568992687947-868a62a9f521", 1400),
      author: 1,
      daysAgo: 44,
      seoTitle: "Unterlagen für den Immobilienverkauf: Checkliste und Beschaffung",
      seoDescription:
      ...
      content: `Unvollständige Unterlagen sind der häufigste Grund für Verzögerungen. Banken finanzieren nicht ohne Nachweise, Notare beurkunden nicht ohne Grundbuchauszug, und Käufer werden misstrauisch, wenn Dokumente fehlen.

## Für jede Immobilie erforderlich

**Grundbuchauszug** — Grundbuchamt am Amtsgericht. Kosten etwa 10–20 €, Dauer wenige Tage. Nicht älter als drei Monate.

**Flurkarte / Liegenschaftskarte** — Katasteramt. Etwa 15–40 €, wenige Tage.

**Energieausweis** — Aussteller je nach Typ. Verbrauchsausweis 80–150 €, Bedarfsausweis 300–500 €. Zwei bis vier Wochen. Muss spätestens bei der Besichtigung unaufgefordert vorgelegt werden.

**Grundriss und Baupläne** — Bauaktenarchiv der Gemeinde. 30–100 €, ein bis vier Wochen.

**Wohnflächenberechnung** — aus den Bauunterlagen oder neu zu erstellen.

**Nachweise zu Modernisierungen** — Rechnungen und Handwerkerbelege der letzten Jahre. Sie belegen den Zustand und rechtfertigen den Preis.

## Zusätzlich bei Eigentumswohnungen

**Teilungserklärung mit Aufteilungsplan** — Grundbuchamt oder Verwaltung.

**Protokolle der Eigentümerversammlungen** — mindestens die letzten drei Jahre. Verwaltung.

**Wirtschaftsplan und Jahresabrechnungen** — Verwaltung.

**Nachweis über die Instandhaltungsrücklage** — Verwaltung.

**Beschlusssammlung** — Verwaltung.

## Zusätzlich bei vermieteten Objekten

- Mietverträge aller Einheiten
- Mieterliste mit Laufzeiten und aktuellen Mieten
- Nebenkostenabrechnungen der letzten zwei Jahre
- Nachweise über Mietanpassungen

## Zusätzlich bei Häusern

- Grundsteuerbescheid
- Nachweise über Anliegerbeiträge
- Wartungsnachweise für Heizung und Kamin
- Bei Öltanks: Nachweis der letzten Prüfung
- Baulastenverzeichnis-Auszug

## Praktischer Hinweis

Beginnen Sie mit der Beschaffung, sobald der Verkauf grundsätzlich feststeht – nicht erst, wenn ein Interessent gefunden ist. Vier Wochen Vorlauf sind realistisch, bei alten Bauakten auch mehr.`,
    },
    {
      slug: "immobilie-geerbt-was-tun",
      ...
      categoryId: cat["recht-und-kosten"],
      readingMinutes: 9,
      coverImage: img("1521737604893-d14cc237f11d", 1400),
      author: 3,
      daysAgo: 57,
      seoTitle: "Immobilie geerbt: Fristen, Erbengemeinschaft, Steuern",
      seoDescription:
      ...
      content: `Ein Erbfall bringt Entscheidungen mit sich, die niemand vorbereitet trifft – oft in einer Situation, in der andere Dinge wichtiger sind. Dieser Überblick soll die zeitkritischen Punkte sortieren.

## Was in den ersten sechs Wochen zählt

**Ausschlagungsfrist: sechs Wochen.** Ab Kenntnis des Erbfalls und der Berufung als Erbe. Bei überschuldeten Nachlässen ist das die einzige Möglichkeit, nicht für Schulden einzustehen. Die Frist ist kurz – wenn Zweifel an der Werthaltigkeit bestehen, sollte sofort geprüft werden.

**Anzeige beim Finanzamt: drei Monate.** Der Erwerb ist dem zuständigen Erbschaftsteuerfinanzamt anzuzeigen.

## Grundbuch berichtigen

Innerhalb von zwei Jahren nach dem Erbfall ist die Grundbuchberichtigung gebührenfrei. Benötigt wird ein Erbschein oder ein notarielles Testament mit Eröffnungsprotokoll. Ohne Grundbuchberichtigung ist kein Verkauf möglich.
...
Für das selbstgenutzte Familienheim gilt eine Sonderregelung: Ehepartner und Kinder erben es steuerfrei, wenn sie unverzüglich selbst einziehen und die Immobilie zehn Jahre lang selbst bewohnen. Bei Kindern ist die Befreiung auf 200 m² Wohnfläche begrenzt.

Wird innerhalb der zehn Jahre verkauft oder vermietet, entfällt die Befreiung rückwirkend.

## Die Erbengemeinschaft

Mehrere Erben bilden eine Gesamthandsgemeinschaft. Das bedeutet praktisch: Verkauft werden kann nur einstimmig. Wenn keine Einigung gelingt, bleibt die Teilungsversteigerung – ein Verfahren, das fast immer zu deutlich niedrigeren Erlösen führt.

Was hilft: früh sprechen, eine unabhängige Bewertung einholen und die Optionen schriftlich gegenüberstellen. Häufig unterschätzen Miterben die laufenden Kosten des Haltens.

## Spekulationssteuer beim Verkauf

Die Zehnjahresfrist läuft nicht neu an – maßgeblich ist der Anschaffungszeitpunkt des Erblassers. Hatte dieser die Immobilie länger als zehn Jahre, ist der Verkauf einkommensteuerfrei.

Ausnahme: Bei durchgehender Selbstnutzung im Verkaufsjahr und den beiden Vorjahren entfällt die Steuer ebenfalls.

## Verkaufen oder behalten?

Für das Behalten sprechen laufende Mieteinnahmen, eine gute Lage und ein guter Bauzustand. Dagegen sprechen anstehender Sanierungsstau, eine Erbengemeinschaft mit unterschiedlichen Interessen und die Frage, wer sich tatsächlich um die Immobilie kümmert.

Rechnen Sie beides durch, bevor Sie entscheiden – inklusive der Instandhaltungskosten der nächsten zehn Jahre.`,
    },
    {
      slug: "energieausweis-verstehen",
      title: "Energieausweis verstehen: Was die Buchstaben bedeuten",
      excerpt:
      ...
      readingMinutes: 7,
      coverImage: img("1509391366360-2e959784a276", 1400),
      author: 2,
      daysAgo: 72,
      seoTitle: "Energieausweis: Verbrauchs- vs. Bedarfsausweis, Klassen erklärt",
      seoDescription:
      ...
      content: `Seit 2014 muss der Energieausweis bei jeder Besichtigung unaufgefordert vorgelegt werden. Seit 2021 sind die Angaben zudem in jeder Immobilienanzeige verpflichtend. Wer das versäumt, riskiert ein Bußgeld von bis zu 10.000 Euro.

## Zwei Arten, ein Dokument

### Verbrauchsausweis

Beruht auf dem tatsächlichen Verbrauch der letzten drei Jahre. Kostet 80–150 €. Der Nachteil: Er misst das Verhalten der Bewohner mit. Ein Haus, in dem ein sparsames Rentnerpaar wohnt, erscheint besser als dasselbe Haus mit einer fünfköpfigen Familie.

### Bedarfsausweis

Beruht auf einer technischen Berechnung von Gebäudehülle und Anlagentechnik – unabhängig vom Nutzerverhalten. Kostet 300–500 €. Er ist aussagekräftiger und für Gebäude mit weniger als fünf Wohneinheiten und Bauantrag vor 1978 ohne entsprechende Sanierung sogar verpflichtend.

## Die Effizienzklassen

Die Skala reicht von A+ bis H und bezieht sich auf den Endenergiebedarf in kWh pro m² und Jahr:

- **A+**: unter 30 – Passivhausstandard
- **A**: 30–50 – Neubau nach aktuellem Standard
- **B**: 50–75 – guter Neubau oder Vollsanierung
- **C**: 75–100 – sanierter Altbau
- **D**: 100–130 – Durchschnitt des deutschen Bestands
- **E**: 130–160
- **F**: 160–200
- **G**: 200–250
- **H**: über 250 – unsanierter Altbau

## Was ein schlechter Wert kostet

Der Einfluss auf den Kaufpreis hat sich seit 2022 deutlich verstärkt. Aktuelle Auswertungen zeigen für Objekte der Klassen G und H Abschläge von 15 bis 25 Prozent gegenüber vergleichbaren Objekten der Klasse C – und zwar nicht wegen der Heizkosten, sondern wegen der erwarteten Sanierungskosten.

## Lohnt sich Sanieren vor dem Verkauf?

Selten vollständig, oft punktuell. Eine neue Heizung kostet 25.000–40.000 €, hebt die Klasse aber meist nur um eine Stufe. Wirtschaftlicher ist häufig:

- ein Bedarfsausweis statt eines schlechten Verbrauchsausweises
- eine Dämmung der obersten Geschossdecke (2.000–5.000 €, spürbare Wirkung)
- ein Sanierungsfahrplan (iSFP), der Käufern zeigt, was zu welchem Preis möglich ist

Der individuelle Sanierungsfahrplan kostet rund 1.500 € und wird zu 50 % gefördert. Für Käufer erhöht er zudem den Förderbonus bei späteren Maßnahmen um 5 Prozentpunkte – ein Argument, das im Verkaufsgespräch wirkt.

## Gültigkeit

Zehn Jahre ab Ausstellung. Danach ist ein neuer Ausweis erforderlich.`,
    },
  ];

  for (const p of posts) {
    const { author, daysAgo: d, ...rest } = p;
    await prisma.blogPost.create({
      data: {
        ...rest,
        authorId: agents[author].id,
        published: true,
